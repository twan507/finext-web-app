...
>
> **VIỆC LỚN CÒN LẠI (owner chốt làm BẢN ĐẦY ĐỦ, chưa bắt đầu):** [**10 — Widget tham chiếu: chặn tận gốc việc AI bịa số**](10-widget-tham-chieu-chong-bia-so.md). Eval bắt được agent **bịa số báo cáo tài chính** (doanh thu không kỳ nào có, sai % lợi nhuận, lấy Q1/2025 gọi là kỳ mới nhất). Guard hiện tại **mù đơn vị** nên không cứu được, và widget hiện tại cũng vô dụng vì **model tự gõ số vào JSON**. Hướng: model chỉ khai *hiện cái gì*, backend điền *giá trị bao nhiêu*. **Quy mô ngang tính năng bubble — cần spec riêng.**
>
