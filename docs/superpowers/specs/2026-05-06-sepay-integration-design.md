...
> **CANCELLED / HISTORICAL:** Thiết kế này đã được gác và chưa được triển khai. Hệ thống hiện dùng luồng admin/manager xác nhận thanh toán thủ công; không có SePay webhook active.

**Date:** 2026-05-06
**Status:** Cancelled — giữ để tham khảo lịch sử thiết kế
