    ...
    <div className="dashboard-card ai-assets-table-card">
      <div className="dashboard-card-header">
        ...
        <div className="card-header-action">
          <button>
            <SyncIcon sx={{ fontSize: getResponsiveFontSize('lg'), mr: 0.5 }} /> Refresh Predictions
          </button>
        </div>
      </div>
      ...
      <div className="table-footer-disclaimer">
        <WarningAmberRoundedIcon sx={{ fontSize: getResponsiveFontSize('lg'), color: 'var(--yellow-400)', mr: 0.5, verticalAlign: 'middle' }} />
