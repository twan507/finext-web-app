        ...
        <Box>
            <Box sx={{
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
                    ...
                    <Box component="span" onClick={() => router.push(`/charts/${ticker.toLowerCase()}`)} sx={{ textDecoration: 'none', cursor: 'pointer' }}>
                        <Typography sx={{
                        ...
                        {currentDiff != null && currentPctChange != null && (
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                <Typography sx={{
                                    fontSize: getResponsiveFontSize('sm'),
                                    fontWeight: fontWeight.semibold,
                                    color: currentDiff === 0 ? theme.palette.trend.ref : (currentDiff > 0 ? theme.palette.trend.up : theme.palette.trend.down),
                                    fontVariantNumeric: 'tabular-nums',
                                }}>
                                ...
                                <Box sx={{
                                    ...
                                    px: 0.75,
                                    py: 0.25,
                                    bgcolor: currentDiff === 0 ? theme.palette.trend.ref : (currentDiff > 0 ? theme.palette.trend.up : theme.palette.trend.down),
                                    color: '#fff',
                                    borderRadius: 1,
                                }}>
                                    {currentDiff !== 0 && (
