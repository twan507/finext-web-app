...
**Khi nào dùng:** diễn biến giá OHLC của một mã/chỉ số qua các phiên — dùng khi khách hỏi "vẽ đồ thị nến/giá của
X". Thêm `volume` (panel khối lượng dưới) và `ma` (đường trung bình động) khi cần đầy đủ.

**Khuôn:** `{template:"candlestick", title?, dates:[str], ohlc:[[open,close,low,high],…], volume?:[num], ma?:{"MA20":[num]}}`.
⚠ Thứ tự mỗi phần tử `ohlc` là **[mở, đóng, thấp, cao]** — KHÔNG phải open-high-low-close. `dates` khớp số nến.

```finext-widget
{"template":"candlestick","title":"VNINDEX 6 phiên gần nhất","dates":["07/07","08/07","09/07","10/07","11/07","14/07"],"ohlc":[[1760,1772,1755,1778],[1772,1768,1762,1781],[1768,1781,1765,1786],[1781,1775,1770,1788],[1775,1783,1772,1790],[1783,1777,1774,1789]],"volume":[18200,16400,21100,17800,19500,15900],"ma":{"MA20":[1758,1762,1766,1769,1772,1774]}}
```

## 8. `heatmap` — bản đồ nhiệt
...
## 11. `radar` — mạng nhện đa chỉ tiêu
...
| Diễn biến giá OHLC + khối lượng của một mã | `candlestick` |
